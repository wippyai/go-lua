...
func TestHooksRequireNarrowSynth_CallHook(t *testing.T) {
	...
	diags := hooks.CheckCalls(graph, api.FlowEvidence{}, nil, observation.New(observation.Config{}), nil, nil, nil, "test.lua")
...
func TestHooksRequireNarrowSynth_ReturnHook(t *testing.T) {
	...
	diags := hooks.CheckReturns(fn, graph, api.FlowEvidence{}, map[cfg.Point]*scope.State{}, baseScope, nil, observation.New(observation.Config{}), "test.lua")
...
func TestHooksRequireNarrowSynth_FieldHook(t *testing.T) {
	...
	diags := hooks.CheckFields(graph, api.FlowEvidence{}, observation.New(observation.Config{}), nil, "test.lua")
...
func TestHooksRequireNarrowSynth_AssignHook(t *testing.T) {
	...
	diags := hooks.CheckAssignments(graph, api.FlowEvidence{}, nil, observation.New(observation.Config{}), nil, "test.lua")
