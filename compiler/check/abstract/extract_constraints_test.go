...
func TestConstraintsFromCallOnReturn_NilInfo(t *testing.T) {
	result := cond.ConstraintsFromCallOnReturn(nil, 0, nil, nil, nil, nil, nil, nil, nil, nil, nil, api.FlowEvidence{})
...
func TestConstraintsFromCallOnReturn_MethodCall(t *testing.T) {
	...
	result := cond.ConstraintsFromCallOnReturn(info, 0, nil, nil, nil, nil, nil, nil, nil, nil, nil, api.FlowEvidence{})
	if result.HasConstraints() {
...
func TestConstraintsFromAssignOnReturn_NilInfo(t *testing.T) {
	result := cond.ConstraintsFromAssignOnReturn(nil, 0, nil, nil, nil, nil, nil, nil, nil, nil, nil, api.FlowEvidence{})
	if result.HasConstraints() {
		t.Error("expected no constraints for nil info")
	}
}
...
func TestConstraintsFromAssignOnReturn_NoSourceCalls(t *testing.T) {
	...
	result := cond.ConstraintsFromAssignOnReturn(info, 0, nil, nil, nil, nil, nil, nil, nil, nil, nil, api.FlowEvidence{})
	if result.HasConstraints() {
