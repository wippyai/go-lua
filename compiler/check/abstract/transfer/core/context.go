// Package base provides shared context types for abstract transfer operations.
package core
...
type FlowContext struct {
	...
	// Derived holds computed resolvers (populated by abstract transfer.Run).
	Derived *Derived

	// Evidence is the transfer-owned graph event trace. It is populated before
	// lowering so all transfer stages and downstream reducers share one event
