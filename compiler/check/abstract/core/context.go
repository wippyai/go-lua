// Package core provides shared context types for abstract interpretation.
package core
...
type FlowContext struct {
	...
	// Derived holds computed resolvers populated by the abstract interpreter.
	Derived *Derived

	// Evidence is the interpreter-owned graph event trace. It is populated before
	// lowering so all reducer stages and downstream consumers share one event
	// source instead of rediscovering CFG events.
