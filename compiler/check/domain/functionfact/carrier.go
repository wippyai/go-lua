...
func paramsTypes(ff api.FunctionFact) []typ.Type      { return product.ProjectVector(ff.Params) }
func bodyParamsTypes(ff api.FunctionFact) []typ.Type  { return product.ProjectVector(ff.BodyParams) }
func entryParamsTypes(ff api.FunctionFact) []typ.Type { return product.ProjectVector(ff.EntryParams) }
func summaryTypes(ff api.FunctionFact) []typ.Type     { return product.ProjectVector(ff.Summary) }
func narrowTypes(ff api.FunctionFact) []typ.Type      { return product.ProjectVector(ff.Narrow) }
