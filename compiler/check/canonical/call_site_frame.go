...
func (f callSiteFrame) typeShapeOutcome(useResolvedSignature bool) canonicalcall.TypeShapeOutcome {
	return canonicalcall.NewTypeShapeOutcome(canonicalcall.TypeShapeInput{
