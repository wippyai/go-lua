...
func (r normalReturnFactProjectAssignmentStub) CapturedSymbols() []symbol.ID {
	if len(r.captures) == 0 {
		return nil
	}
	out := make([]symbol.ID, 0, len(r.captures))
...
func (r normalReturnFactProjectResultStub) DiagnosticOutput() callpayload.DiagnosticOutput {
