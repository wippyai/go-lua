...
func mainLoop(L *LState, baseframe *callFrame) {
	// Set background context and delegate to context version
	...
	for {
		...
		default:
			...
			case OP_ADD:
				...
				v2, ok2 := rhs.(LNumber)
				if ok1 && ok2 {
					v := numberArith(L, OP_ADD, LNumber(v1), LNumber(v2))
					// this section is inlined by go-inline
			...
			case OP_SUB:
				...
				v2, ok2 := rhs.(LNumber)
				if ok1 && ok2 {
					v := numberArith(L, OP_SUB, LNumber(v1), LNumber(v2))
					// this section is inlined by go-inline
					// source function is 'func (rg *registry) SetNumber(regi int, vali LNumber) ' in '_state.go'
					{
						rg := reg
			...
			case OP_MUL:
				...
				v2, ok2 := rhs.(LNumber)
				if ok1 && ok2 {
					v := numberArith(L, OP_MUL, LNumber(v1), LNumber(v2))
					// this section is inlined by go-inline
					// source function is 'func (rg *registry) SetNumber(regi int, vali LNumber) ' in '_state.go'
					{
						rg := reg
			...
			case OP_DIV:
				...
				v2, ok2 := rhs.(LNumber)
				if ok1 && ok2 {
					v := numberArith(L, OP_DIV, LNumber(v1), LNumber(v2))
					// this section is inlined by go-inline
					// source function is 'func (rg *registry) SetNumber(regi int, vali LNumber) ' in '_state.go'
					{
						rg := reg
			...
			case OP_MOD:
				...
				v2, ok2 := rhs.(LNumber)
				if ok1 && ok2 {
					v := numberArith(L, OP_MOD, LNumber(v1), LNumber(v2))
					// this section is inlined by go-inline
					// source function is 'func (rg *registry) SetNumber(regi int, vali LNumber) ' in '_state.go'
					{
						rg := reg
			...
			case OP_POW:
				...
				v2, ok2 := rhs.(LNumber)
				if ok1 && ok2 {
					v := numberArith(L, OP_POW, LNumber(v1), LNumber(v2))
					// this section is inlined by go-inline
					// source function is 'func (rg *registry) SetNumber(regi int, vali LNumber) ' in '_state.go'
					{
						rg := reg
