...
import (
	...
	typestate "github.com/wippyai/go-lua/domain/typestate"
)

// DenseCoordinate is typestate's dense Factor coordinate: the position a key of this
...
// ForeignRead seals one exact read of a bound typestate Factor at this axis's own
...
func ForeignRead(foreign execution.ForeignFactor, coordinate execution.SelectedCoordinate, input uint16) (execution.ExactRead[DenseCoordinate, typestate.Abstract], bool) {
	return execution.ForeignExactRead[DenseCoordinate, typestate.Abstract](foreign, coordinate.Unit, input)
}

// ForeignSelectedMember resolves one dense coordinate of a bound typestate Factor
...
func ForeignSelectedMember(foreign execution.ForeignFactor, dense uint32, tag uint64) (execution.RouteMember, bool) {
	return execution.ForeignSelectedMember[DenseCoordinate, typestate.Abstract](foreign, dense, tag)
}

// RelationOwner is the generated bind-time owner for typestate's member relations.
...
func NewRelationOwner(schema Space) *RelationOwner {
