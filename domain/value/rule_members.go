...
func AxisMemberCatalog() member.Catalog {
	...
	catalog, ok := member.NewCatalog(
		[]member.Relation{
			...
			{Key: FormalFreezeCallActuals, Subject: MountedCallActualsCarrier, CandidateProvider: member.AxisRelationCandidate(member.RelationRef{Axis: schemaapi.EntryReference{Surface: schemaapi.SurfaceKind(2), Key: "value"}, Member: "value/formal-freeze/call-actuals"})},
