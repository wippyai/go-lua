...
func allocationRequirementID(heapID, keyID, artifactID, mount, programID, allocation, localID identity.ContentID, kind AllocationKind, form AllocationForm) identity.ContentID {
...
func (requirement AllocationRequirement) Form() AllocationForm {
	if !requirement.valid() {
