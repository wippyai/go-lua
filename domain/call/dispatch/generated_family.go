// Code generated by the rule family emitter from the "call-dispatch" rule declaration; DO NOT EDIT.
//
...
func NewFamilyInstaller(callSchema *call.Algebra, valueSchema *value.Schema, heapSchema heap.Schema) (execution.RuleFamilyInstaller[call.DenseCoordinate, call.Value], bool) {
	install := familyInstaller{callSchema: callSchema, valueSchema: valueSchema, heapSchema: heapSchema}
...
func (install familyInstaller) available() bool {
	return install.callSchema != nil && install.valueSchema != nil
}
