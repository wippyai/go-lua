// Package program owns the opaque call site's callback-free rule declaration.
//
...
// The the opaque call site family identities. These are declaration keys, not runtime handles:
...
const (
	...
	RuleKey     schema.Key = "effect-opaque"
	RuleRole               = "rule/effect/callsite-opaque"
	OperandRole            = "operand/effect/callsite-opaque"
	...
	Reducer                     schema.Key = effectdomain.OpaqueCallEffectReducer
)
...
// RuleEntry is the canonical callback-free the opaque call site rule declaration. The family is
...
// OpaqueCallEffect returns the immutable the opaque call site rule declaration.
//
...
// predecessor world.
func OpaqueCallEffect() ruleprogram.Program {
