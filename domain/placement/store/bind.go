...
// InstallFamily is Store's one generated RuleFamily claimant. It authenticates
// the two schemas the emitted installer is sealed against against the mounted
// authorities that issued them, then claims this rule's sealed ordinal on the
// Factor it writes.
//
