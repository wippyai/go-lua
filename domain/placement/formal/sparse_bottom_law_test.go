...
func TestFormalSparseActualBottomIsTheFactorDefault(t *testing.T) {
	...
	fixture.cells[0] = execution.MemberCell[valuedomain.Value]{Value: fact, Present: true}
	...
	sparse[0] = execution.MemberCell[valuedomain.Value]{Value: fixture.values.Bottom()}
