...
// ForeignSelectedMember resolves one dense coordinate of a bound static-type Factor
...
func ForeignSelectedMember(foreign execution.ForeignFactor, dense uint32, tag uint64) (execution.RouteMember, bool) {
	return execution.ForeignSelectedMember[DenseCoordinate, TypeFact](foreign, dense, tag)
}
