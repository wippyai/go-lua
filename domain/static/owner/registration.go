...
func AlgebraAxis(owner *HotOwner) (axis.Algebra[staticdomain.TypeFact], bool) {
	...
	return axis.Adopt(axis.CarrierAlgebra[coordinate, staticdomain.TypeFact]{
		KeyEnd:      spec.KeyEnd,
		Lattice:     spec.Lattice,
		Default:     spec.Default,
		AdmitAt:     spec.AdmitAt,
		Fingerprint: spec.Fingerprint,
		Widen:       axis.CarrierRank[coordinate, staticdomain.TypeFact]{Width: spec.WidenRank.Width, At: spec.WidenRank.At},
	})
}
