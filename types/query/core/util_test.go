...
func TestKeyType(t *testing.T) {
	tests := []struct {
		...
		{"open record", typ.NewRecord().SetOpen(true).Field("a", typ.String).Build(), typ.String},
...
func TestValueType(t *testing.T) {
	tests := []struct {
		...
		{"open record", typ.NewRecord().SetOpen(true).Field("a", typ.String).Build(), typ.NewUnion(typ.String, typ.Unknown)},
