...
func RecursiveFamilyFingerprintWithin(t Type, maxNodes int) (uint64, bool) {
	if t == nil {
		return 0, true
	}
...
func (s *recursiveFamilyFingerprintScan) scan(t Type) {
...
func (s *recursiveFamilyFingerprintScan) add(rec *Recursive) {
	if rec == nil || s == nil {
		return
	}
	var id uint64
