...
| --- | --- | --- | --- | --- |
| Judgment IR | `judgment.JIRSchemaVersion` | v4 | Judgment code registry and exported judgment record shape. | A judgment code, code metadata, or exported judgment/evidence/subject field shape changes. |
