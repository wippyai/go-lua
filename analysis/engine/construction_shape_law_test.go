...
var dyingConstructionSymbols = []dyingConstructionSymbol{
	...
	{name: "RuleImplementation.AdmitMounted", present: true, note: "mounted admission through the builder"},
	{name: "RuleImplementation.AdmitLink", present: true, note: "Link admission through the builder"},
	{name: "RuleProgramAttach.AdmitMounted", present: true, note: "the interface half of mounted admission"},
	{name: "RuleProgramAttach.AdmitLink", present: true, note: "the interface half of Link admission"},
	...
	{name: "BindingTopologyBuilder.AddActivationRule", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.AddActivationRuleFromDraft", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.AddRule", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.AddRuleFromDraft", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.AdmitLinkRuleOccurrence", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.AdmitMountedRuleOccurrence", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.AdmitMountedRuleOperand", present: true, note: "builder method"},
	...
	{name: "BindingTopologyBuilder.IssueRuleSourceWithSurfaces", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.IssueRuleSourceWithSurfacesWithFailure", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.QueueLinkRuleFinalizer", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.QueueMountedQueryBatch", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.QueueMountedRuleFinalizer", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.SealFailure", present: true, note: "builder method"},
	...
	{name: "BindingTopologyBuilder.claimMountedSelectedSurface", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.claimMountedSurface", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.commit", present: false, note: "carried by the constructor cut"},
	{name: "BindingTopologyBuilder.currentRuleFinalizerFailure", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.currentRuleSourceSealFailure", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.drainQueryBatches", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.drainRuleFinalizers", present: true, note: "builder method"},
	...
	{name: "BindingTopologyBuilder.lowerArtifactRows", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.queueRuleFinalizer", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.recordRuleFinalizerFailure", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.recordRuleSourceSealFailure", present: true, note: "builder method"},
	{name: "BindingTopologyBuilder.sealSources", present: true, note: "builder method"},
}
...
var mutatingAdmissionPins = []constructionPin{
	...
	{symbol: "BindingTopologyBuilder.QueueMountedQueryBatch", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.SealSources", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.claimMountedSurface", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.drainQueryBatches", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.drainRuleFinalizers", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.queueRuleFinalizer", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "ExactQueryImplementation.bindConstruction", via: "ProgramConstruction", count: 1, step: stepSingleEntry},
	{symbol: "MountedActivationCandidateIssuer.AddMountedActivationCandidate", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
	{symbol: "MountedActivationCandidateIssuer.CompleteMountedActivationCandidates", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
	{symbol: "MountedActivationCandidateIssuer.validFor", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
	...
	{symbol: "RuleImplementation.AdmitLink", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
	{symbol: "RuleImplementation.AdmitMounted", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
	...
	{symbol: "RuleImplementation.admitRule", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
	{symbol: "RuleImplementation.issueDraft", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
...
var exportedBuilderParamPins = []constructionPin{
	{symbol: "AdmitLinkRule", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
	{symbol: "AdmitMountedActivationOccurrence", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
	{symbol: "AdmitMountedRule", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
	{symbol: "AdmitMountedRuleWithFailure", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
	...
	{symbol: "BeginMountedActivationRuleAdmission", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
	{symbol: "BeginMountedRuleOccurrence", via: "BindingTopologyBuilder", count: 1, step: stepSealedInput},
	{symbol: "BindingTopology.Graph", via: "BindingTopology", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.Abort", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.AddActivationRule", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.AddActivationRuleFromDraft", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.AddRule", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.AddRuleFromDraft", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.AdmitLinkRuleOccurrence", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.AdmitMountedRuleOccurrence", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.AdmitMountedRuleOperand", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.IssueRuleSourceWithSurfaces", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.IssueRuleSourceWithSurfacesWithFailure", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.QueueLinkRuleFinalizer", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.QueueMountedQueryBatch", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.QueueMountedRuleFinalizer", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.SealFailure", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	{symbol: "BindingTopologyBuilder.SealSources", via: "BindingTopologyBuilder", count: 1, step: stepSpineDeletion},
	...
	{symbol: "RuleImplementation.AttachLinkMember", via: "ProgramConstruction", count: 1, step: stepSingleEntry},
	{symbol: "RuleImplementation.AttachMountedMember", via: "ProgramConstruction", count: 1, step: stepSingleEntry},
	{symbol: "RuleProgramAttach.AdmitLink", via: "BindingTopologyBuilder", count: 1, step: stepSingleEntry},
	{symbol: "RuleProgramAttach.AdmitMounted", via: "BindingTopologyBuilder", count: 1, step: stepSingleEntry},
