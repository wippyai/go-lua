...
func ruleUnitForSemantic(key SemanticKey) ruleUnit { return ruleUnit{content: key.Digest()} }
...
func mustRuleOperandFamily() SemanticKey {
	key, ok := NewSemanticKey([32]byte{0x72, 0x75, 0x6c, 0x65, 0x2d, 0x75, 0x6e, 0x69, 0x74, 0x2d, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x6e, 0x64}, 1)
	if !ok {
