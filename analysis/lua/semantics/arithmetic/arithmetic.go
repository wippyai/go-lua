...
// ExactArithmeticLiteral is the Lua frontend's sole concrete arithmetic
// evaluator for two exact numeric literals. It is shared by reusable artifact
// summaries and abstract domains, preventing a Link- or Result-side fold from
// becoming a second arithmetic authority.
...
// ExactUnaryNegLiteral is the Lua frontend's sole concrete evaluator for an
// authored unary numeric negation. Keeping this beside ExactArithmeticLiteral prevents
