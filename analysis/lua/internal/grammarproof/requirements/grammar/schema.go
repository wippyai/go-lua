// Package grammar derives the parser-owned AST schema used by cold semantic
// coverage proofs. It does not run fixtures, bind source, or lower a Program.
package grammar
...
func constructorClass(structType *goast.StructType) ConstructorClass {
	for _, field := range structType.Fields.List {
		...
		switch embeddedName(field.Type) {
		case "StmtBase":
