...
func TestDirectCallArgumentsRefutesConcreteMismatch(t *testing.T) {
	result := checkFunction(t, `function f() need_string(1) end`, stringSignatureManifest())

	got := obligationpass.New(obligationpass.DirectCallArguments{}).Run(obligationpass.Context{
...
func TestDirectCallArgumentsSkipsProvenArgument(t *testing.T) {
...
func TestDirectCallArgumentsUsesBoundaryProofForGuardedVariantField(t *testing.T) {
...
func TestDirectCallArgumentsUsesLocalFunctionContract(t *testing.T) {
...
func TestDirectCallArgumentsLabelsNamedArgument(t *testing.T) {
...
func TestDirectCallArgumentsAcceptsOptionalParameterNil(t *testing.T) {
...
func TestDirectCallArgumentsInstantiatesGenericLocalContract(t *testing.T) {
...
func TestDirectCallArgumentsReportsGenericConstraintViolation(t *testing.T) {
...
func TestDirectCallArgumentsCarriesMissingRequiredFieldEvidenceDetail(t *testing.T) {
...
func TestDirectCallArgumentsCarriesMayBeNilEvidenceDetail(t *testing.T) {
	result := testutil.CheckFile(`local function need_string(value: string): () end
...
func TestDirectCallArgumentsReportsGenericInferenceConflictAtContributor(t *testing.T) {
...
func TestDirectCallArgumentsReportsSummaryParamObligation(t *testing.T) {
...
func TestDirectCallArgumentsPointsAtObjectLiteralMemberMismatch(t *testing.T) {
...
func TestDirectCallArgumentsReportsForwardedHelperParamObligation(t *testing.T) {
...
helper(bedrock_client, model_id)`, "main.lua", testutil.WithStdlib(), testutil.WithModule("bedrock_client", clientMod))
	...
	p := obligationpass.New(obligationpass.DirectCallArguments{})
...
func TestDirectCallArgumentsUsesImportedModuleMemberContract(t *testing.T) {
...
func TestDirectCallArgumentsUsesImportedOptionalFieldFromModuleReturn(t *testing.T) {
	jsonMod := testutil.CheckAndExport(`local json = {}
function json.decode(src: string): any
    return {}
end
...
func TestDirectCallArgumentsUsesJoinedImportedOptionalFieldFromModuleReturn(t *testing.T) {
	jsonMod := testutil.CheckAndExport(`local json = {}
function json.decode(src: string): any
    return {}
end
...
func TestDirectCallArgumentsBindsColonReceiverSlot(t *testing.T) {
...
func TestDirectCallArgumentsAcceptsInferredCallbackReturn(t *testing.T) {
...
func TestDirectCallArgumentsKeepsUntrustedAnyUnknown(t *testing.T) {
