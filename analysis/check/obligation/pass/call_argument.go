...
// CallArguments emits call-argument type obligations from solved state.
type CallArguments struct{}

func (CallArguments) Name() string {
	return "call.argument_type"
}

func (CallArguments) Produce(ctx Context) []judgment.Judgment {
