...
type TypestateRequirement = readapi.TypestateRequirement
...
type ShapePolymorphic = readapi.ShapePolymorphic
type ShapeConditionalField = readapi.ShapeConditionalField
