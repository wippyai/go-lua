...
const (
	...
	labelAdviceShapeUse              = "shape-relevant use"
	labelAdviceShapeConditionalField = "conditionally present field"
)
...
var sourceLabelPlacements = map[string]diagnostic.LabelPlacement{
	...
	labelAdviceShapeUse:              diagnostic.LabelPlacementBelow,
	labelAdviceShapeConditionalField: diagnostic.LabelPlacementAbove,
