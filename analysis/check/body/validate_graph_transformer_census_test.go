...
func TestValidateGraphTransformerEligibilityCensusIsInstanceExact(t *testing.T) {
	...
	want := map[string]counts{
		"RootAssignments":               {total: 56, exact: 14, unboundPath: 12},
		...
		"extension:1":                   {total: 38, exact: 4, iteratorCall: 34},
	}
	...
	t.Log("validate_graph exact now: CallSite 33/49 (19 iterator + 6 pure scalar + 8 allocation), RootAssignment 14/56, Return 2/5")
}
