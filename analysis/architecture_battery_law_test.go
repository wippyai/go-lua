...
var architectureBatteryEngineEnumeration = map[string]struct{}{
	...
	"analysis/engine/internal/equation:PrototypeRow":                   {},
	...
	"analysis/engine/internal/equation:VariantPlan.OwnsPrototypeRow":   {},
	"analysis/engine/internal/equation:VariantPlan.PrototypeRows":      {},
...
var architectureBatteryReceiptVocabulary = map[string]struct{}{
	...
	"analysis/engine:MountedFunctionBoundaryReceipt":                          {},
	...
	"analysis/engine:SchemaSelectWriteReceipt":                                {},
