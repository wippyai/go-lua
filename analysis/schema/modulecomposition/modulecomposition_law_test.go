...
func makeLawProgram(t *testing.T) lawProgram {
	...
	summaryRule, summaryRuleOK := programschema.NewRuleOccurrenceWithInputs(schema.Key("module-call-transition-summary-law"), schema.Key("module-call-transition-law-axis"), 0, summaryPointID, []identity.ContentID{dispatchPointID}, programissuance.StageCallSummary, programissuance.InputCallDispatchStage, programschema.RuleOccurrenceRoute{}, true, programschema.RuleOccurrenceSource{})
