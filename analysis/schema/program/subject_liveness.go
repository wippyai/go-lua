...
// Appended after storage-cell lifetime so all existing Program family slots
// remain stable.
const slotSubjectLiveness = slotStorageCellLifetime + 1

var subjectLivenessFamily = Family[SubjectLiveness]{slot: slotSubjectLiveness, name: "subject-liveness"}

func SubjectLivenessFamily() Family[SubjectLiveness] { return subjectLivenessFamily }
