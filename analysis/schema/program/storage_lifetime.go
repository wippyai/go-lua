...
// This family is appended after the current static type catalog. Its slot is
// deliberately never reused by an existing Program family.
const slotStorageCellLifetime = slotStaticTypeNodeReferenceCanonicalKey + 1

var storageCellLifetimeFamily = Family[StorageCellLifetime]{
	slot: slotStorageCellLifetime,
	name: "storage-cell-lifetime",
}

func StorageCellLifetimeFamily() Family[StorageCellLifetime] { return storageCellLifetimeFamily }
