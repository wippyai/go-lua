...
var generatorSourceFiles = [...]string{
	"schema/relations/linkownership/cmd/main.go",
	"schema/relations/linkownership/doc.go",
	"schema/relations/linkownership/generator/declarations.go",
	"schema/relations/linkownership/generator/gate.go",
	"schema/relations/linkownership/generator/population.go",
	"schema/relations/linkownership/generator/projections.go",
	"schema/relations/linkownership/generator/run.go",
	"schema/relations/linkownership/generator/scanner.go",
	"schema/relations/linkownership/generator/structure_projection.go",
	"schema/relations/linkownership/generator/typed_schema.go",
	"schema/relations/linkownership/generator/typewalk.go",
}
