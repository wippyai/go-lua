...
const (
	relationSchemaPath  = "schema/relations/catalog.schema"
	relationHistoryPath = "schema/relations/catalog.history"
	relationRetiredPath = "schema/relations/catalog.retired"
	semanticSourcePath  = "program/semanticsource/generated.go"
	relationSourcePath  = "schema/relations/generated.go"
)
...
func emitSemanticSource(entries []entry) ([]byte, error) {
	...
	var out bytes.Buffer
	out.WriteString("// Code generated from schema/relations/catalog.schema; DO NOT EDIT.\n\npackage semanticsource\n\nconst (\n")
