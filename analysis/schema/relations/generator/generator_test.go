...
func TestCheckedInOutputsAreFresh(t *testing.T) {
	...
	for _, output := range []struct {
		...
		{path: filepath.Join("..", "..", "..", "program", "semanticsource", "generated.go"), want: semantic},
...
func checkFixture(t *testing.T) string {
	...
	for destination, source := range map[string]string{
		...
		filepath.Join(root, semanticSourcePath):  filepath.Join("..", "..", "..", "program", "semanticsource", "generated.go"),
