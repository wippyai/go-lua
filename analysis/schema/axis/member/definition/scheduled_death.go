...
var scheduledDeaths = []ScheduledDeath{
	...
	{
		Axis:     "value",
		Relation: "value/fresh-result/routes",
		Build: GoSymbol{
			PackagePath: "github.com/wippyai/go-lua/domain/value/freshresult",
			Name:        "DeriveFreshResultRoutes",
			ResultIndex: 0,
		},
	},
	{
	...
	{
		Axis:     "placement",
		Relation: "placement/publication-escape/routes",
		Build: GoSymbol{
			PackagePath: "github.com/wippyai/go-lua/domain/placement/publicationescape",
			Name:        "DerivePublicationRoutesFromComposition",
			ResultIndex: 0,
		},
	},
	{
		Axis:     "value",
		Relation: "value/result-alias/routes",
		Build: GoSymbol{
			PackagePath: "github.com/wippyai/go-lua/domain/value/resultalias/aliasroute",
			Name:        "Derive",
			ResultIndex: 0,
		},
	},
