...
func TestCanonicalFunctionSignatureContentSupportsRecursiveBinder(t *testing.T) {
	...
	want := []byte(`{"schema":"go-lua.signature.content/v2","hasType":true,"type":{"kind":"function","params":[{"type":{"kind":"recursive","name":"Node","binder":1,"body":{"kind":"record","fields":[{"name":"next","type":{"kind":"recursiveRef","binder":1}}]}}}],"returns":[{"kind":"recursiveRef","binder":1}]}}`)
