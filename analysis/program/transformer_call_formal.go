...
func (formal CallFormal) ID() identity.ContentID {
	if !formal.Available() {
...
func (argument CallTypeArgument) ProgramID() identity.ContentID {
	if !argument.Available() {
		return identity.ContentID{}
	}
...
func (argument CallTypeArgument) StaticTypeReferenceID() (identity.ContentID, bool) {
	if !argument.Available() {
		return identity.ContentID{}, false
	}
...
func callFormalID(formal CallFormal) identity.ContentID {
