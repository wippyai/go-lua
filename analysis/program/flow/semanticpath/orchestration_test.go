...
func TestDeriveRequiresTheExactOwnerQuartetBeforeConstructingPlanes(t *testing.T) {
	...
	if planes, err := derive(source.View{}, source.CellRoles{}, authored.View{}, &body.Result{}, binding.Result{}, &containment.Result{}, &outcome.Result{}, ids[0], ids[1], ids[2], ids[3]); err == nil || planes.terms[keyspace.FamilyBody] != nil {
