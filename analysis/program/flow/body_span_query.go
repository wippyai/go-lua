...
// retained visited index or an allocation. Valid sealed chains return at the
// first Site exactly as the former root query did.
func (view View) FinishSite(term keyspace.Term) (Site, bool) {
