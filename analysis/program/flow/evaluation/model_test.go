...
func openPortsFixture(t *testing.T, counts [keyspace.FamilyCount]uint32, flow authored.Input, nilCount int) portsFixture {
	...
	return portsFixture{identity: identity, sourceFinalize: finalize, view: view, flowFinalize: flowFinalize, staticView: staticView, forest: forest}
}
...
func TestPortsRejectExpiredSourceAndRetainNoAuthority(t *testing.T) {
	...
	if _, err := SealPorts(source.Identity{}, fixture.view, fixture.forest,
		fixture.staticView.ContentID(), fixture.view.ModuleID()); err == nil {
...
func TestPortsRejectForeignEqualCardinalityForest(t *testing.T) {
	...
	if _, err := SealPorts(second.identity, second.view, first.forest,
		second.staticView.ContentID(), second.view.ModuleID()); err == nil {
...
func TestPortsMatchesRejectsUnavailableAndEqualDenominatorForeignOwners(t *testing.T) {
	...
	if Matches(nil, sourceID, flowID, staticID, moduleID) || Matches(firstPorts, identity.ContentID{}, flowID, staticID, moduleID) ||
		Matches(firstPorts, sourceID, identity.ContentID{}, staticID, moduleID) ||
		Matches(firstPorts, sourceID, flowID, identity.ContentID{}, moduleID) || Matches(firstPorts, sourceID, flowID, staticID, identity.ContentID{}) {
