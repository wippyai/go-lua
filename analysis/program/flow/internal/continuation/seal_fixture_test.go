...
func openContinuationFixture(t *testing.T, spec continuationSpec) *continuationFixture {
	...
	if err != nil {
		closeContinuationFinalizers(sourceFinalize, staticFinalize, authored.Finalizer{}, imports.Finalizer{})
	...
	if err != nil {
		closeContinuationFinalizers(sourceFinalize, staticFinalize, flowFinalize, imports.Finalizer{})
	...
	if err != nil {
		closeContinuationFinalizers(source.Finalizer{}, staticFinalize, flowFinalize, imports.Finalizer{})
...
func closeContinuationFinalizers(sourceFinalize source.Finalizer, staticFinalize static.Finalizer, flowFinalize authored.Finalizer, moduleFinalize imports.Finalizer) {
