...
func writeClaims(writer *framing.Writer, claims claimStore) error {
...
func writeOperators(writer *framing.Writer, operators operatorStore) error {
...
func writeAuthoredControl(writer *framing.Writer, control authoredControlStore) error {
...
func writeFunctions(writer *framing.Writer, functions functionStore) error {
...
func writeCalls(writer *framing.Writer, calls callStore) error {
...
func writeAccess(writer *framing.Writer, access accessStore) error {
...
func writeStorage(writer *framing.Writer, storage storageStore) error {
...
func writeValues(writer *framing.Writer, values valueStore) error {
...
func writeTables(writer *framing.Writer, tables tableStore) error {
...
func writeTerm(writer *framing.Writer, term keyspace.Term) error {
	if term == 0 {
