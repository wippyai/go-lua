...
func validateInputs(preimage source.Preimage, flow authored.View, bodies *body.Result, bindings flowbinding.Result, staticView static.View, moduleView imports.View) error {
