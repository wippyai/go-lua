...
func (result *Result) ResolveContextID(id identity.ContentID) (Boundary, bool) {
...
// immutable map built during sealing.
func (result *Result) ResolveBodyContextID(id identity.ContentID) (BodyBoundary, bool) {
	if !result.valid() || !id.Available() {
		return BodyBoundary{}, false
	}
...
func (boundary Boundary) ContextID() identity.ContentID {
...
func (boundary BodyBoundary) ContextID() identity.ContentID {
	if !boundary.available() {
		return identity.ContentID{}
	}
