...
var (
	...
	errInvalidArtifactSection   = errors.New("program/imports: invalid artifact section")
)
...
func readArtifactTerm(reader *framing.Reader) (keyspace.Term, error) {
...
func readArtifactImport(reader *framing.Reader, index uint64) (Import, error) {
