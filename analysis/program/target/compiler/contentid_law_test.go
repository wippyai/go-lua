...
func TestContentIDIsCanonicalAndOwned(t *testing.T) {
	left := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{
	...
	right := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{
		contentIDOperation("beta", []vocabulary.OutcomeSpec{{Kind: flowkind.OutcomeNormal, Values: vocabulary.ValuesSpec{Tail: vocabulary.ValuesClosed}}}),
		contentIDOperation("alpha", []vocabulary.OutcomeSpec{
			{Kind: flowkind.OutcomeNormal, Values: vocabulary.ValuesSpec{Fixed: []schematype.Type{testBoolean}, Tail: vocabulary.ValuesClosed}},
			{Kind: flowkind.OutcomeThrow, Values: vocabulary.ValuesSpec{Fixed: []schematype.Type{testString}, Tail: vocabulary.ValuesClosed}},
	...
	changed := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{
		contentIDOperation("alpha", []vocabulary.OutcomeSpec{
			{Kind: flowkind.OutcomeThrow, Values: vocabulary.ValuesSpec{Fixed: []schematype.Type{testString}, Tail: vocabulary.ValuesClosed}},
...
func TestContentIDTypeOccurrenceAllocationsAreConstant(t *testing.T) {
	seal := func(width int) *contract.Contract {
...
func TestContentIDIncludesDerivedOpaqueSemanticsAndFailsClosed(t *testing.T) {
	empty := mustSeal(t, declaration.Spec{})
	if !empty.ContentID().Available() {
		t.Fatal("opaque-only contract has no ContentID")
	}
	if (&contract.Contract{}).ContentID().Available() || (*contract.Contract)(nil).ContentID().Available() {
		t.Fatal("unavailable contract produced a ContentID")
	}

	withProtocol := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{contentIDOperation("acquire", []vocabulary.OutcomeSpec{{
...
func TestContentIDTypeFormalAlphaInvariant(t *testing.T) {
	...
	left := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{genericBuiltin("identity", leftFormal)}})
	right := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{genericBuiltin("identity", rightFormal)}})
...
func TestContentIDOperationEncodingTracksCanonicalOutcomeRows(t *testing.T) {
	...
	left := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{contentIDOperation("operation", base)}}).ContentID()
	changed := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{contentIDOperation("operation", []vocabulary.OutcomeSpec{{Kind: flowkind.OutcomeNormal, Values: vocabulary.ValuesSpec{Fixed: []schematype.Type{testBoolean}, Tail: vocabulary.ValuesClosed}}})}}).ContentID()
	if left == changed {
...
func TestContentIDSubedgeEncodingTracksRouteAuthority(t *testing.T) {
	leftSpec := declaration.Spec{Operations: []vocabulary.OperationSpec{protectedSubedgeOperation("subedge-id", false, false, false)}}
	rightSpec := declaration.Spec{Operations: []vocabulary.OperationSpec{protectedSubedgeOperation("subedge-id", true, false, false)}}
...
func TestContentIDValueEncodingTracksFrozenTypeDeclarations(t *testing.T) {
	left := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{contentIDOperation("value-id", []vocabulary.OutcomeSpec{{Kind: flowkind.OutcomeNormal, Values: vocabulary.ValuesSpec{Fixed: []schematype.Type{testString}, Tail: vocabulary.ValuesClosed}}})}}).ContentID()
	right := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{contentIDOperation("value-id", []vocabulary.OutcomeSpec{{Kind: flowkind.OutcomeNormal, Values: vocabulary.ValuesSpec{Fixed: []schematype.Type{testNumber}, Tail: vocabulary.ValuesClosed}}})}}).ContentID()
	if left == right {
...
func TestContentIDSemanticFamilyDeltas(t *testing.T) {
	cases := []struct {
		name string
		pair func() (*contract.Contract, *contract.Contract)
	}{
		{"binding", func() (*contract.Contract, *contract.Contract) {
			return deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{deltaPlain("left")}}), deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{deltaPlain("right")}})
		}},
		{"input type", func() (*contract.Contract, *contract.Contract) {
			left, right := deltaPlain("input"), deltaPlain("input")
			right.Input.Fixed[0] = testNumber
			return deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{left}}), deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{right}})
		}},
		{"formal constraint", func() (*contract.Contract, *contract.Contract) {
			left := testNewTypeParam("T", testString)
			right := testNewTypeParam("T", testNumber)
			return deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{genericBuiltin("formal", left)}}), deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{genericBuiltin("formal", right)}})
		}},
		{"Values tail", func() (*contract.Contract, *contract.Contract) {
		...
		{"Values tail class", func() (*contract.Contract, *contract.Contract) {
		...
		{"Values suffix", func() (*contract.Contract, *contract.Contract) {
		...
		{"callback", func() (*contract.Contract, *contract.Contract) {
			left, right := deltaCallbackOperation("callback", 0, 0, false), deltaCallbackOperation("callback", 1, 0, false)
			return deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{left}}), deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{right}})
		}},
		{"callback lifecycle", func() (*contract.Contract, *contract.Contract) {
		...
		{"callback outcome", func() (*contract.Contract, *contract.Contract) {
		...
		{"Produced capture", func() (*contract.Contract, *contract.Contract) {
			left, right := deltaProduced(0), deltaProduced(1)
			return deltaSeal(t, left), deltaSeal(t, right)
		}},
		{"suspension", func() (*contract.Contract, *contract.Contract) {
			left, right := deltaSuspension(vocabulary.ReentryOnce), deltaSuspension(vocabulary.ReentryMany)
			return deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{left}}), deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{right}})
		}},
		{"resume", func() (*contract.Contract, *contract.Contract) {
			left, right := deltaResume(0), deltaResume(1)
			return deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{left}}), deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{right}})
		}},
		{"transfer", func() (*contract.Contract, *contract.Contract) {
			left, right := deltaTransfer(vocabulary.TransferMayDeliver), deltaTransfer(vocabulary.TransferMayReject)
			return deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{left}}), deltaSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{right}})
		}},
		{"effect", func() (*contract.Contract, *contract.Contract) {
			return deltaSeal(t, deltaEffects(2)), deltaSeal(t, deltaEffects(3))
		}},
		{"protocol finality", func() (*contract.Contract, *contract.Contract) {
			return deltaSeal(t, deltaProtocolFinal(false)), deltaSeal(t, deltaProtocolFinal(true))
		}},
		{"protocol transition", func() (*contract.Contract, *contract.Contract) {
			return deltaSeal(t, deltaProtocolTransition(false)), deltaSeal(t, deltaProtocolTransition(true))
		}},
		{"protocol escape", func() (*contract.Contract, *contract.Contract) {
...
func deltaSeal(t *testing.T, spec declaration.Spec) *contract.Contract { return mustSeal(t, spec) }
...
func deltaProduced(capture uint32) declaration.Spec {
	...
	return declaration.Spec{Operations: []vocabulary.OperationSpec{parent, child}}
}
...
func deltaEffects(target vocabulary.SpecRef) declaration.Spec {
	...
	return declaration.Spec{Operations: operations}
}

func deltaProtocolFinal(final bool) declaration.Spec {
...
func deltaProtocolTransition(swapped bool) declaration.Spec {
...
func deltaProtocolEscape(ordinal uint32) declaration.Spec {
	return declaration.Spec{
