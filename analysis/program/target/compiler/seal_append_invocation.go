...
func querySubedgeInputs(draft *operationDraft, values map[string]vocabulary.Values, keys exactkey.Table, effectCount int) ([]operationvalue.SubedgeInput, *operationvalue.SubedgeRelationInput, error) {
	if draft == nil {
