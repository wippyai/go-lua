...
func endpointIdentityOperationAndTransfer(t testing.TB, c *contract.Contract, name string) (vocabulary.Operation, vocabulary.TransferID) {
	t.Helper()
...
func endpointIdentitySnapshotFor(t testing.TB, c *contract.Contract, name string) endpointIdentitySnapshot {
	t.Helper()
...
func TestEndpointIdentityExcludesUnrelatedTargetRecords(t *testing.T) {
	base := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{
		endpointIdentityOperation("alpha"),
	}})
	withUnrelatedOperation := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{
		endpointIdentityOperation("alpha"),
...
func TestEndpointIdentityTracksExactLocalSemanticMutations(t *testing.T) {
	base := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{endpointIdentityOperation("alpha")}})
	...
	assertEndpointIdentityChanged(t,
		endpointIdentitySnapshotFor(t, mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{operationMutation}}), "alpha"),
		prior,
	)
	...
	assertEndpointIdentityChanged(t,
		endpointIdentitySnapshotFor(t, mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{transferMutation}}), "alpha"),
		prior,
	)
	...
	assertEndpointIdentityChanged(t,
		endpointIdentitySnapshotFor(t, mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{outcomeMutation}}), "alpha"),
		prior,
	)
}

func TestEndpointIdentityKeepsDistinctSealedTransferDeclarations(t *testing.T) {
	first := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{endpointIdentityTwoTransferOperation("two-transfers")}})
	second := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{endpointIdentityTwoTransferOperation("two-transfers")}})
...
func TestEndpointIdentityScopesCrossContractHandlesAndRejectsUnavailable(t *testing.T) {
	local := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{
		endpointIdentityOperation("local-alpha"),
		endpointIdentityOperation("local-beta"),
	}})
	foreign := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{
...
func TestEndpointIdentityQueriesAllocateNothing(t *testing.T) {
	contract := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{endpointIdentityOperation("allocation")}})
...
// equivalent contract.Contract. The portable ContentID is the value for cross-contract
// comparison; the contract.Contract remains the handle owner.
func TestEndpointIdentityDocumentsReceiverLocalScalarHandles(t *testing.T) {
	left := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{endpointIdentityOperation("same")}})
	right := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{endpointIdentityOperation("same")}})
...
func TestEndpointIdentityIgnoresEarlierGlobalCallbackAndEffectCoordinates(t *testing.T) {
	...
	spawnBase := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{spawnTestOperation("spawn-id")}})
	...
	spawnSpec := declaration.Spec{Operations: []vocabulary.OperationSpec{spawnTestOperation("spawn-id"), endpointIdentityOperation("aardvark-spawn")}}
...
func TestEndpointIdentityUsesSymbolicEffectAndProducedAnchors(t *testing.T) {
	...
	callbackBaseSpec := declaration.Spec{Operations: []vocabulary.OperationSpec{deltaCallbackOperation("callback-result", 0, 1, true)}}
	...
	callbackEarlier := declaration.Spec{Operations: []vocabulary.OperationSpec{deltaCallbackOperation("callback-result", 0, 1, true), endpointIdentityOperation("aardvark-callback-result")}}
	...
	callbackMutation := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{deltaCallbackOperation("callback-result", 0, 2, true)}})
...
func TestEndpointIdentitySubedgeCallbackSelectorLocalityAndMutation(t *testing.T) {
	base := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{callbackLifecycleOperation("subedge-callback", vocabulary.CallbackSyncOptionalOnce, vocabulary.CallbackSyncOptionalOnce)}})
	...
	withEarlier := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{callbackLifecycleOperation("subedge-callback", vocabulary.CallbackSyncOptionalOnce, vocabulary.CallbackSyncOptionalOnce), endpointIdentityOperation("aardvark-subedge")}})
	...
	mutation := mustSeal(t, declaration.Spec{Operations: []vocabulary.OperationSpec{mutated}})
...
func endpointIdentityTransferDependencies(callback vocabulary.CallbackRef) declaration.Spec {
...
func endpointIdentityEffectCycle(reverse bool) declaration.Spec {
	...
	return declaration.Spec{Operations: []vocabulary.OperationSpec{a, b}}
}

func endpointIdentityReleaseCycle(reverse bool) declaration.Spec {
	closed := vocabulary.ValuesSpec{Tail: vocabulary.ValuesClosed}
...
func TestEndpointIdentityCyclesAreFiniteAndPermutationStable(t *testing.T) {
	for _, cycle := range []struct {
		name  string
		build func(bool) declaration.Spec
