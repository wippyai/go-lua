...
func TestStaticInputRowsRequireTheirDeclaredOperandShape(t *testing.T) {
	row := StaticInputRow{id: valuesLawID(1), owner: valuesLawID(2), kind: StaticInputTypeOf, expression: valuesLawID(3), source: valuesLawID(4), target: valuesLawID(5), operand: valuesLawID(6), frontier: valuesLawID(7), operandKind: StaticInputOperandKnown}
