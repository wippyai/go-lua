...
type TypeFormalArguments struct {
	...
	operationID      identity.ContentID
	correspondenceID identity.ContentID
	call             keyspace.Term
	count            int
	ready            bool
}
...
func (v TypeFormalArguments) CorrespondenceID() (id identity.ContentID, ok bool) {
	if !v.valid() {
		return id, false
	}
...
func (v TypeFormalArguments) deriveCorrespondenceID() (id identity.ContentID, ok bool) {
...
func (v TypeFormalArguments) correspondenceIDLocked(scratch *typeFormalIDScratch) (id identity.ContentID, ok bool) {
