...
func boundaryValueSourceCount(input *program.Program, family keyspace.Family) int {
...
// boundaryValueSourceIdentityAt is the narrow pre-Artifact join needed while
// Boundary seals its semantic inverse. It proves canonical Source/Flow/Static
// ownership and delegates the exact scalar equations to schema/program.
func boundaryValueSourceIdentityAt(input *program.Program, family keyspace.Family, index int) (sourceID, spanID identity.ContentID, term keyspace.Term, ok bool) {
	...
	spanID, direct, spanOK := boundaryValueSourceSpan(input, term)
...
func boundaryValueSourceSpan(input *program.Program, term keyspace.Term) (identity.ContentID, bool, bool) {
