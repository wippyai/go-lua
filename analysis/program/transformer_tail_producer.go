...
func issueTailProducer(input TransformerInput, span Span) (TailProducer, bool) {
	...
	context := transformerSemanticID("program/transformer/tail-producer", func(writer *framing.Writer) bool {
...
func (producer TailProducer) ContextID() identity.ContentID {
	if !producer.Available() {
