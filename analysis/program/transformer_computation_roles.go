...
func (row UnaryOccurrence) ContextID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.span.ContextID()
}
func (row UnaryOccurrence) BodyPathID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.body.PathID()
}
func (row UnaryOccurrence) OperandID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
...
func (row BinaryArithmeticOccurrence) ContextID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.span.ContextID()
...
func (row BinaryArithmeticOccurrence) BodyPathID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.body.PathID()
...
func (row BinaryArithmeticOccurrence) LeftID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
...
func (row BinaryArithmeticOccurrence) RightID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
...
func (row BinaryOrderOccurrence) ContextID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.span.ContextID()
...
func (row BinaryOrderOccurrence) BodyPathID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.body.PathID()
...
func (row BinaryOrderOccurrence) LeftID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.leftSpan.ContextID()
...
func (row BinaryOrderOccurrence) RightID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.rightSpan.ContextID()
...
func (row BinaryEqualityOccurrence) ContextID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.span.ContextID()
...
func (row BinaryEqualityOccurrence) BodyPathID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.body.PathID()
...
func (row BinaryEqualityOccurrence) LeftID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.leftSpan.ContextID()
...
func (row BinaryEqualityOccurrence) RightID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.rightSpan.ContextID()
...
func (row BinaryEqualityOccurrence) Comparison() (branch, whenTrue, whenFalse identity.ContentID, invert bool, ok bool) {
...
func (row SelectOccurrence) ContextID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.span.ContextID()
}
func (row SelectOccurrence) BodyPathID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.body.PathID()
}
func (row SelectOccurrence) LeftID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.leftSpan.ContextID()
}
func (row SelectOccurrence) RightID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.rightSpan.ContextID()
...
func (row ClaimOccurrence) ContextID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.span.ContextID()
}
func (row ClaimOccurrence) BodyPathID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.body.PathID()
}
func (row ClaimOccurrence) OperandID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.operandSpan.ContextID()
...
func (row ReturnOccurrence) ContextID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.span.ContextID()
}
func (row ReturnOccurrence) BodyPathID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
	return row.body.PathID()
}
func (row ReturnOccurrence) ValuesID() identity.ContentID {
	if !row.Available() {
		return identity.ContentID{}
	}
