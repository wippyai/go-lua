...
// analysis/internal/programartifact can import its issuer package.
...
// exact programschema CompilationReceipt.
func Issue(schema keyspace.ContentID, abi uint64) (Capability, bool) {
...
func (capability Capability) SchemaDigest() keyspace.ContentID {
