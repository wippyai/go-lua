...
func (row StaticTypeArgumentRow) ID() keyspace.ContentID {
	if !row.Available() {
		return keyspace.ContentID{}
	}
	return row.id
}
func (row StaticTypeArgumentRow) CallID() keyspace.ContentID {
	if !row.Available() {
		return keyspace.ContentID{}
	}
	return row.call
}
func (row StaticTypeArgumentRow) ReferenceID() keyspace.ContentID {
	if !row.Available() {
		return keyspace.ContentID{}
	}
	return row.reference
}
func (row StaticTypeArgumentRow) TypesID() keyspace.ContentID {
	if !row.Available() {
		return keyspace.ContentID{}
	}
	return row.types
...
func (row StaticTypeValueRow) ID() keyspace.ContentID {
	if !row.Available() {
		return keyspace.ContentID{}
	}
	return row.id
}
func (row StaticTypeValueRow) BodyPathID() keyspace.ContentID {
	if !row.Available() {
		return keyspace.ContentID{}
	}
	return row.body
}
func (row StaticTypeValueRow) ReferenceID() keyspace.ContentID {
	if !row.Available() {
		return keyspace.ContentID{}
	}
	return row.reference
}
func (row StaticTypeValueRow) RootID() keyspace.ContentID {
	if !row.Available() {
		return keyspace.ContentID{}
	}
	return row.root
