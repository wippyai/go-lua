...
`)})
	...
	var occurrenceID keyspace.ContentID
...
func ruleForOccurrence(artifact *programartifact.Artifact, role programartifact.RuleRole, occurrence keyspace.ContentID) (programartifact.RuleOccurrenceRow, bool) {
