// Package framing owns Program's strict framed binary encoding primitive.
...
var (
	...
	ErrNilDestination = errors.New("program framing: nil destination")
	// ErrFinished rejects writes after Finish.
	ErrFinished = errors.New("program framing: writer finished")
)
