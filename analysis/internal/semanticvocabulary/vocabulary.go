// Package semanticvocabulary owns the closed, process-independent semantic
...
type Bundle struct {
	ValueFactor, ValueSummary, CallFactor, HeapFactor, PackFactor, EffectFactor engine.SemanticKey
...
func (bundle Bundle) Available() bool {
	keys := [...]engine.SemanticKey{
		bundle.ValueFactor, bundle.ValueSummary, bundle.CallFactor, bundle.HeapFactor, bundle.PackFactor, bundle.EffectFactor,
