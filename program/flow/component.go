...
func (assembly *Assembly) Take() (*source.Component, *Component, *static.Component, *module.Component, error) {
...
// semanticSourceAvailable is the composition fence for Flow's owner-local
// semantic-source publication. The ordinary authored availability fence above
// remains intentionally weaker because artifact writers consume authored Flow
// without requiring every post-assembly projection.
func (view View) semanticSourceAvailable() bool {
	if !view.available() {
		return false
	}
