...
func hashSiteContext(sourceID, flowID, staticID, moduleID keyspace.ContentID, term keyspace.Term) keyspace.ContentID {
	...
	offset += 8
	for _, owner := range [...]keyspace.ContentID{sourceID, flowID, staticID, moduleID} {
...
func (s Site) ContextID() keyspace.ContentID {
	if !s.available() {
...
func (r *Result) resolveSite(id keyspace.ContentID) (Site, bool) {
...
func (r *Result) ResolveContextID(id keyspace.ContentID) (Site, bool) {
