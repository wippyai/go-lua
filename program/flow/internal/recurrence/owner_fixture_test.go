...
func openOwnerFixture(t *testing.T, spec ownerSpec) *ownerFixture {
	...
	if err != nil {
		closeOwnerFinalizers(sourceFinalize, staticFinalize, authored.Finalizer{}, module.Finalizer{})
	...
	if err != nil {
		closeOwnerFinalizers(sourceFinalize, staticFinalize, flowFinalize, module.Finalizer{})
...
func closeOwnerFinalizers(sourceFinalize source.Finalizer, staticFinalize static.Finalizer, flowFinalize authored.Finalizer, moduleFinalize module.Finalizer) {
