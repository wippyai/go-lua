...
func (c *Certificate) Matches(sourceID, flowID, staticID, moduleID keyspace.ContentID) bool {
...
func (c *Certificate) BodyPathAt(sourceID, flowID, staticID, moduleID keyspace.ContentID, ordinal uint32) (keyspace.ContentID, bool) {
...
func (c *Certificate) RootPathAt(sourceID, flowID, staticID, moduleID keyspace.ContentID, family keyspace.Family, ordinal uint32) (keyspace.ContentID, bool) {
...
func (c *Certificate) TermPathAt(sourceID, flowID, staticID, moduleID keyspace.ContentID, family keyspace.Family, ordinal uint32) (keyspace.ContentID, bool) {
...
func Seal(issuance *source.SemanticPathIssuance, cellRoles source.CellRoleCatalog, view source.View, authoredView authored.View, bodies *body.Result, bindings binding.Result, forest *containment.Result, outcomes *outcome.Result, flowID, staticID, moduleID keyspace.ContentID) (*Certificate, error) {
	...
	certificate := &Certificate{state: &certificateState{sourceID: sourceID, flowID: flowID, staticID: staticID, moduleID: moduleID, body: append([]keyspace.ContentID(nil), planes.body...)}}
	...
	for family := keyspace.Family(1); family < keyspace.FamilyCount; family++ {
		...
		certificate.state.roots[family] = append([]keyspace.ContentID(nil), planes.roots[family]...)
		certificate.state.terms[family] = append([]keyspace.ContentID(nil), planes.terms[family]...)
...
func (c *certificateState) matches(sourceID, flowID, staticID, moduleID keyspace.ContentID) bool {
...
func (r *VertexCatalogReceipt) Consume(sourceID, flowID, staticID, moduleID keyspace.ContentID) (*VertexCatalogPaths, bool) {
...
func (r *OutcomePhaseReceipt) Consume(sourceID, flowID, staticID, moduleID keyspace.ContentID) (*OutcomePhasePaths, bool) {
	if r == nil || r.state == nil {
		return nil, false
	}
	state := r.state
...
func (p *OutcomePhasePaths) At(term keyspace.Term) (keyspace.ContentID, bool) {
...
func (p *VertexCatalogPaths) BodyAt(ordinal uint32) (keyspace.ContentID, bool) {
...
func (p *VertexCatalogPaths) RootAt(family keyspace.Family, ordinal uint32) (keyspace.ContentID, bool) {
...
func (p *VertexCatalogPaths) TermAt(family keyspace.Family, ordinal uint32) (keyspace.ContentID, bool) {
...
func (r *CausalReceipt) Consume(sourceID, flowID, staticID, moduleID keyspace.ContentID) (*CausalPaths, bool) {
	if r == nil || r.state == nil {
		return nil, false
	}
	state := r.state
...
func (p *CausalPaths) At(family keyspace.Family, ordinal uint32) (keyspace.ContentID, bool) {
	if p == nil || p.certificate == nil || family <= keyspace.FamilyInvalid || family >= keyspace.FamilyCount || ordinal == 0 || uint64(ordinal) >= uint64(len(p.certificate.terms[family])) {
		return keyspace.ContentID{}, false
	}
	id := p.certificate.terms[family][ordinal]
