...
func openPendingFixture(
	...
	if err != nil {
		closePendingFinalizers(sourceFinalize, staticFinalize, flowFinalize, module.Finalizer{})
...
func closePendingFinalizers(sourceFinalize source.Finalizer, staticFinalize static.Finalizer, flowFinalize authored.Finalizer, moduleFinalize module.Finalizer) {
