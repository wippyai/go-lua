...
// push validates one edge and records a composite occurrence. A zero owner
// means this is a root; authored children must match their row's lexical Body.
func (walker *Session) push(term, expectedOwner keyspace.Term) error {
	return walker.pushWithPrefix(term, expectedOwner, 0)
}
