...
func openBinaryPrimitiveFixture(t *testing.T, comparisonOp flowkind.BinaryOp) *binaryPrimitiveFixture {
	...
	if err != nil {
		closeBinaryPrimitiveFinalizers(sourceFinal, staticFinal, authored.Finalizer{}, module.Finalizer{})
	...
	if err != nil {
		closeBinaryPrimitiveFinalizers(sourceFinal, staticFinal, flowFinal, module.Finalizer{})
...
func closeBinaryPrimitiveFinalizers(sourceFinal source.Finalizer, staticFinal static.Finalizer, flowFinal authored.Finalizer, moduleFinal module.Finalizer) {
	_ = moduleFinal.Abort()
	_ = flowFinal.Abort()
	_ = staticFinal.Abort()
	_ = sourceFinal.Abort()
...
func TestBinaryPrimitiveSealRejectsForeignOrUnavailableProvenance(t *testing.T) {
	...
	if _, err := Seal(fixture.sourceView, fixture.flow, candidateResult, fixture.causal, keyspace.ContentID{}, fixture.moduleID); err == nil {
