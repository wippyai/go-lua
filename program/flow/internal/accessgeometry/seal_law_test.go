...
func openAccessGeometryFixtureNamed(t *testing.T, name string) *accessGeometryFixture {
	...
	if err != nil {
		closeAccessGeometryFinalizers(sourceFinal, staticFinal, authored.Finalizer{}, module.Finalizer{})
	...
	if err != nil {
		closeAccessGeometryFinalizers(sourceFinal, staticFinal, flowFinal, module.Finalizer{})
...
func closeAccessGeometryFinalizers(sourceFinal source.Finalizer, staticFinal static.Finalizer, flowFinal authored.Finalizer, moduleFinal module.Finalizer) {
	_ = moduleFinal.Abort()
	_ = flowFinal.Abort()
	_ = staticFinal.Abort()
	_ = sourceFinal.Abort()
