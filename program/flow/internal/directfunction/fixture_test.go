...
func openDirectFixture(t *testing.T, spec directSpec) *directFixture {
	...
	if err != nil {
		closeDirectFinalizers(sourceFinalize, staticFinalize, flowFinalize, module.Finalizer{})
...
func closeDirectFinalizers(sourceFinalize source.Finalizer, staticFinalize static.Finalizer, flowFinalize authored.Finalizer, moduleFinalize module.Finalizer) {
