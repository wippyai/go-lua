...
func openSemanticFixture(t *testing.T, spec semanticSpec) *semanticFixture {
	...
	if err != nil {
		closeSemanticFinalizers(sourceFinalize, staticFinalize, authored.Finalizer{}, module.Finalizer{})
	...
	if err != nil {
		closeSemanticFinalizers(sourceFinalize, staticFinalize, flowFinalize, module.Finalizer{})
...
func closeSemanticFinalizers(sourceFinalize source.Finalizer, staticFinalize static.Finalizer, flowFinalize authored.Finalizer, moduleFinalize module.Finalizer) {
