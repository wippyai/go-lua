...
func TestModuleEntryImportRejectsDuplicateCallClaim(t *testing.T) {
	...
	moduleView := moduleEntryModule(t, module.Input{Imports: []module.Import{
...
func newModuleEntryImportFixture(
	...
	return moduleEntryImportFixture{
		...
		module: moduleEntryModule(t, module.Input{Imports: []module.Import{{Term: terms.imported, Call: terms.call, Request: terms.request}}}),
		terms:  terms,
	}
}
