...
func (occurrence SemanticOccurrence) ID() keyspace.ContentID {
...
func (template AllocationTemplate) ID() keyspace.ContentID {
...
func (allocation Allocation) ID() keyspace.ContentID {
	if !allocation.Available() {
		return keyspace.ContentID{}
	}
...
func (field AllocationField) ID() keyspace.ContentID {
