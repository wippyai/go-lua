...
func (outcome Outcome) PathID() keyspace.ContentID {
...
func (outcome Outcome) TargetPath() (keyspace.ContentID, OutcomeTargetKind, bool) {
	if !outcome.body.input.OwnsBodyOutcome(outcome) {
		return keyspace.ContentID{}, OutcomeTargetInvalid, false
	}
