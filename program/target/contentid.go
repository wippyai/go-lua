...
func (c *Contract) ContentID() (id keyspace.ContentID) {
...
// to this semantic codec; canonical.Writer does not know target's schema.
const (
...
func encodeContract(w *canonical.Writer, c *Contract) error {
	if c == nil {
...
func encodeBoot(w *canonical.Writer, c *Contract) error {
...
func encodeExactKey(w *canonical.Writer, c *Contract, key ExactKey) error {
...
func encodeInitialValue(w *canonical.Writer, c *Contract, value InitialValue) error {
...
func encodeOperation(w *canonical.Writer, c *Contract, op Operation) error {
...
func encodeBindingSegments(w *canonical.Writer, c *Contract, op Operation, binding int, owner bool) error {
...
func encodeSubedge(w *canonical.Writer, c *Contract, owner Operation, edge SubedgeID) error {
...
func encodeSubedgeRoute(w *canonical.Writer, c *Contract, owner Operation, route SubedgeRoute, adjustment Adjustment, result Values, placement Placement, offset uint32, outcome uint32, sibling SubedgeID, destination Values) error {
...
func encodeValues(w *canonical.Writer, c *Contract, values Values) error {
...
func encodeType(w *canonical.Writer, c *Contract, value Type) error {
...
func encodeOutcome(w *canonical.Writer, c *Contract, op Operation, outcome int) error {
...
func encodeEffect(w *canonical.Writer, c *Contract, op Operation, effect int) error {
...
func encodeEffectRow(w *canonical.Writer, c *Contract, effect effectRow) error {
...
func encodeCoordinate(w *canonical.Writer, kind, ordinal uint64) error {
