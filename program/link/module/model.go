...
func (r ModuleInitGenerationRef) ComponentID() keyspace.ContentID { return r.component }
func (r ModuleInitGenerationRef) EntryID() keyspace.ContentID     { return r.entry }
...
func (r ModuleInitTerminalRef) ComponentID() keyspace.ContentID {
...
type authority struct {
	...
	rootByID           map[keyspace.ContentID]uint32
	coordinateByID     map[keyspace.ContentID]uint32
	entryByID          map[keyspace.ContentID]uint32
	outcomeByID        map[keyspace.ContentID]outcomeCoordinate
	terminals          []outcomeCoordinate // direct projection index; At is O(1)
	terminalByID       map[keyspace.ContentID]uint32
	spec               Spec
	content            keyspace.ContentID
	semanticReceipt    SemanticSourceReceipt
	hostRelation       keyspace.ContentID
	fence              *coldFence
}
...
func (c Cold) ContentID() keyspace.ContentID { return c.content }
...
func (c *Component) ContentID() keyspace.ContentID {
...
func hostRelationID(a *authority) (id keyspace.ContentID) {
...
func content(a *authority) (id keyspace.ContentID) {
