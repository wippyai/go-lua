...
func (c *Component) HostRelationID() (keyspace.ContentID, bool) {
...
func (c Roots) ID(root AnalysisRoot) (keyspace.ContentID, bool) {
	if !valid(c, root.ordinal, len(c.component.authority.roots)) || root.component != c.component {
		return keyspace.ContentID{}, false
	}
	return denseID(c.component.authority.content, 0x6d6f64756c652d72, uint64(root.ordinal)), true
}
func (c Roots) Find(id keyspace.ContentID) (AnalysisRoot, bool) {
...
func (c Cache) EntryID(entry ModuleCacheEntry) (keyspace.ContentID, bool) {
	if !valid(c.component, entry.ordinal, len(c.component.authority.entries)) || entry.component != c.component {
		return keyspace.ContentID{}, false
	}
...
func (c Cache) InstanceID(instance ModuleCacheInstance) (keyspace.ContentID, bool) {
	if !valid(c.component, instance.ordinal, len(c.component.authority.instances)) || instance.component != c.component {
		return keyspace.ContentID{}, false
	}
	return denseID(c.component.authority.content, 0x6d6f64756c652d69, uint64(instance.ordinal)), true
}
func (c Cache) FindEntry(id keyspace.ContentID) (ModuleCacheEntry, bool) {
	if !live(c.component) || !id.Available() {
		return ModuleCacheEntry{}, false
	}
...
func (c Coordinates) ID(coordinate ModuleCoordinate) (keyspace.ContentID, bool) {
	if !valid(c.component, coordinate.ordinal, len(c.component.authority.coordinates)) || coordinate.component != c.component {
		return keyspace.ContentID{}, false
	}
	return denseID(c.component.authority.content, 0x6d6f64756c652d63, uint64(coordinate.ordinal)), true
}
func (c Coordinates) Find(id keyspace.ContentID) (ModuleCoordinate, bool) {
	if !live(c.component) || !id.Available() {
		return ModuleCoordinate{}, false
	}
...
func (c Generations) ID(g ModuleInitGeneration) (keyspace.ContentID, bool) {
	ref, ok := c.Ref(g)
	if !ok {
		return keyspace.ContentID{}, false
	}
...
func (c Outcomes) ID(o ModuleInitOutcome) (keyspace.ContentID, bool) {
	ref, ok := c.Ref(o)
	if !ok {
		return keyspace.ContentID{}, false
	}
...
func (c Outcomes) Find(id keyspace.ContentID) (ModuleInitOutcome, bool) {
	if !live(c) {
		return ModuleInitOutcome{}, false
	}
...
func (c Terminals) ID(t ModuleInitTerminal) (keyspace.ContentID, bool) {
	if !c.component.validTerminal(t) {
		return keyspace.ContentID{}, false
	}
...
func (c Terminals) Find(id keyspace.ContentID) (ModuleInitTerminal, bool) {
	if !live(c) {
		return ModuleInitTerminal{}, false
	}
...
func (a *authority) indexes() error {
	...
	a.coordinateByID = make(map[keyspace.ContentID]uint32, len(out))
	for i, row := range out {
	...
	a.rootByID = make(map[keyspace.ContentID]uint32, len(a.roots))
	for i := range a.roots {
	...
	a.entryByID = make(map[keyspace.ContentID]uint32, len(a.entries))
	...
	a.outcomeByID = map[keyspace.ContentID]outcomeCoordinate{}
	a.terminalByID = map[keyspace.ContentID]uint32{}
	for i := range a.entries {
...
func denseID(seed keyspace.ContentID, tag uint64, ordinal uint64) keyspace.ContentID {
	if !seed.Available() {
...
func hashGeneration(r ModuleInitGenerationRef) keyspace.ContentID {
...
func hashOutcome(r ModuleInitOutcomeRef) keyspace.ContentID {
