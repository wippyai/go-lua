...
func (v Operators) live() bool    { return viewLive(v.authority, v.draft) }
...
func (c *Component) MountRelationID() (keyspace.ContentID, bool) {
...
func (c *Component) ApplicationRelationID() (keyspace.ContentID, bool) {
...
func (v Cold) TargetID() keyspace.ContentID {
	if !v.live() {
...
func coldSnapshot(a *authority, fence *draftFence) Cold {
	...
	return Cold{
		...
		semanticReceipt: a.semanticReceipt,
		fence:           fence,
	}
}
