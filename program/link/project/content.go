...
// authority.
func contentID(targetID keyspace.ContentID, mounts []mountRow) (id keyspace.ContentID) {
...
func mountRelationID(mounts []mountRow) (id keyspace.ContentID) {
	h := sha256.New()
	var w canonical.Writer
...
// root identity.
func applicationRelationID(applications []applicationRow) (id keyspace.ContentID) {
	h := sha256.New()
	var w canonical.Writer
