...
func (v Capabilities) ID(x ProviderCapability) (keyspace.ContentID, bool) {
	c := v.component
	if !validCap(c, x) {
...
func (v CapabilitySeeds) ID(x ProviderCapabilitySeed) (keyspace.ContentID, bool) {
	ref, ok := v.Ref(x)
	if !ok {
		return keyspace.ContentID{}, false
	}
...
func (v BootRoots) ID(x BootRoot) (keyspace.ContentID, bool) {
	c := v.component
...
func (v Globals) ID(x GlobalBinding) (keyspace.ContentID, bool) {
	c := v.component
