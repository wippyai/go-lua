...
func (a *authority) replaySelectorRows(exposures []ReplaySelector, members []ReplayMemberSelector) error {
	...
	build := func(valueID, endpointID keyspace.ContentID, capability string, dispatch HostDispatch, member bool) (selectorRow, error) {
...
func contentID(a *authority) (id keyspace.ContentID) {
...
func encodeHostLiteral(w *canonical.Writer, value keyspace.LiteralValue) error {
