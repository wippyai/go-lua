...
func seedRelationID(a *authority, denied []target.InitialValue) (id keyspace.ContentID) {
...
func endpointRelationID(contract *target.Contract, endpoints []endpointDraft) (id keyspace.ContentID) {
	if contract == nil {
		return id
	}
	h := sha256.New()
...
func writeBinding(writer *canonical.Writer, binding target.BindingSpec) error {
...
func endpointLocalID(contract *target.Contract, op target.Operation, request endpointRequestRow) (id keyspace.ContentID, ok bool) {
...
func seededID(domain string, relation keyspace.ContentID, ordinal uint32) (id keyspace.ContentID, ok bool) {
...
func operationSeedID(contract *target.Contract, op target.Operation) (keyspace.ContentID, bool) {
...
func loaderSeedID(a *authority, mount uint32, op target.Operation) (id keyspace.ContentID, ok bool) {
...
func deniedSeedID(contract *target.Contract, value target.InitialValue) (keyspace.ContentID, bool) {
...
func (s Seeds) ID(seed Seed) (keyspace.ContentID, bool) {
	if !s.valid(seed) {
		return keyspace.ContentID{}, false
	}
	row := s.component.authority.seedTable.rows[seed.ordinal]
...
func (e Endpoints) ID(endpoint Endpoint) (keyspace.ContentID, bool) {
	if !e.valid(endpoint) {
		return keyspace.ContentID{}, false
	}
...
func endpointSeedID(a *authority, endpoint uint32) (keyspace.ContentID, bool) {
...
func (e Endpoints) FindID(id keyspace.ContentID) (Endpoint, bool) {
