...
func (input TransformerInput) CallAt(index int) (CallOccurrence, bool) {
	...
	callSemanticID := transformerSemanticID("program/transformer/call-occurrence-semantic", func(writer *canonical.Writer) bool {
...
func (call CallOccurrence) ContextID() keyspace.ContentID {
	if !call.Available() {
...
func (call CallOccurrence) buildContextID() keyspace.ContentID {
	...
	return transformerRoleID("program/transformer/call-occurrence", call.input.programID, func(writer *canonical.Writer) bool {
...
func (operand CallOperand) ContextID() keyspace.ContentID {
	if !operand.Available() {
		return keyspace.ContentID{}
	}
	return transformerRoleID("program/transformer/call-operand", operand.input.programID, func(writer *canonical.Writer) bool {
...
func (types CallTypeArguments) ContextID() keyspace.ContentID {
	if !types.Available() {
		return keyspace.ContentID{}
	}
	return transformerRoleID("program/transformer/call-type-arguments", types.input.programID, func(writer *canonical.Writer) bool {
...
func (argument CallTypeArgument) ContextID() keyspace.ContentID {
	if !argument.Available() {
		return keyspace.ContentID{}
	}
	return transformerRoleID("program/transformer/call-type-argument", argument.input.programID, func(writer *canonical.Writer) bool {
