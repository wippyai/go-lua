...
func bindingWitnessLocalDeclaration(t *testing.T, line int, stmts []ast.Stmt, result *bind.Result, p *program.Program) {
	...
	bindingKind(t, result, id, symbol.Local)
...
func bindingWitnessFunctionDeclaration(t *testing.T, line int, stmts []ast.Stmt, result *bind.Result, p *program.Program) {
	...
	bindingKind(t, result, id, symbol.Global)
...
func bindingLocalSymbol(t *testing.T, result *bind.Result, local *ast.LocalAssignStmt, index int, name string) symbol.ID {
	t.Helper()
...
func bindingKind(t *testing.T, result *bind.Result, id symbol.ID, want symbol.Kind) {
	t.Helper()
