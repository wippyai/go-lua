...
func (catalog CellRoleCatalog) ExactIDForKey(key keyspace.Key) (keyspace.ContentID, bool) {
...
func exactAtomContentID(value keyspace.LiteralValue) (id keyspace.ContentID) {
	h := sha256.New()
