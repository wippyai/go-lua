...
func (source ValueSourceOccurrence) StaticTypeReferenceID() (keyspace.ContentID, bool) {
...
func (source ValueSourceOccurrence) StaticTypeValueRootID() (keyspace.ContentID, bool) {
...
func (anchor ValueSourceAnchor) ContextID() keyspace.ContentID {
	if !anchor.Available() {
		return keyspace.ContentID{}
	}
	return transformerSemanticID("program/transformer/value-source-anchor", func(writer *canonical.Writer) bool {
		pathID := anchor.path
...
func (source ValueSourceOccurrence) ContextID() keyspace.ContentID {
	if !source.Available() {
		return keyspace.ContentID{}
	}
	bodyID, anchorID, bodyPath := source.body.ContextID(), source.anchor.ContextID(), source.body.PathID()
	return transformerSemanticID("program/transformer/value-source-occurrence", func(writer *canonical.Writer) bool {
...
func (read StorageReadOccurrence) ContextID() keyspace.ContentID {
	if !read.Available() {
		return keyspace.ContentID{}
	}
	bodyID, entryID, finishID := read.body.ContextID(), read.entry.ContextID(), read.finish.ContextID()
	return transformerRoleID("program/transformer/storage-read", read.input.programID, func(writer *canonical.Writer) bool {
...
func (bind StorageBind) ContextID() keyspace.ContentID {
	if !bind.Available() {
		return keyspace.ContentID{}
	}
	bodyID, entryID, finishID := bind.body.ContextID(), bind.entry.ContextID(), bind.finish.ContextID()
	return transformerRoleID("program/transformer/storage-bind", bind.input.programID, func(writer *canonical.Writer) bool {
...
func (occurrence StorageBindOccurrence) ContextID() keyspace.ContentID {
	if !occurrence.Available() {
		return keyspace.ContentID{}
	}
	bindID := occurrence.bind.ContextID()
	return transformerRoleID("program/transformer/storage-bind-transfer", occurrence.bind.input.programID, func(writer *canonical.Writer) bool {
...
func (assignment StorageAssignment) ContextID() keyspace.ContentID {
	...
	return transformerSemanticID("program/transformer/storage-assignment", func(writer *canonical.Writer) bool {
...
func (write StorageWriteOccurrence) ContextID() keyspace.ContentID {
	if !write.Available() {
		return keyspace.ContentID{}
	}
	assignmentID, finishID, predecessorID := write.assignment.ContextID(), write.finish.ContextID(), write.predecessor.ContextID()
	return transformerRoleID("program/transformer/storage-write-transfer", write.assignment.input.programID, func(writer *canonical.Writer) bool {
...
func (predecessor AssignmentPredecessor) ContextID() keyspace.ContentID {
	if !predecessor.Available() {
		return keyspace.ContentID{}
	}
	finishID, digest := predecessor.finish.ContextID(), predecessor.identity.Digest()
	return transformerRoleID("program/transformer/assignment-predecessor", predecessor.input.programID, func(writer *canonical.Writer) bool {
		return writer.Bytes(finishID[:]) == nil && writer.Bytes(predecessor.route[:]) == nil && writer.Bytes(digest[:]) == nil
	})
}

func (predecessor AssignmentPredecessor) RouteDigest() (keyspace.ContentID, bool) {
	if !predecessor.Available() {
		return keyspace.ContentID{}, false
	}
...
func (predecessor AssignmentPredecessor) RouteID() (keyspace.ContentID, bool) {
	if !predecessor.Available() {
		return keyspace.ContentID{}, false
	}
...
func writeTransformerTerm(writer *canonical.Writer, term keyspace.Term) bool {
...
func writeTransformerOptionalTerm(writer *canonical.Writer, term keyspace.Term) bool {
	if writer == nil {
		return false
	}
	if term == 0 {
		return writer.Bool(false) == nil
	}
	return writer.Bool(true) == nil && writeTransformerTerm(writer, term)
}
