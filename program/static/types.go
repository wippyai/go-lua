...
func writeTypesContent(writer *canonical.Writer, store typeStore) error {
...
func writeTypeTermRangesContent(writer *canonical.Writer, rows []poolRange, terms []keyspace.Term) error {
...
func writeTypeTermsContent(writer *canonical.Writer, terms []keyspace.Term) error {
