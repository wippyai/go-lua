...
func statesCanonical(w *canonical.Writer, rows []grammarproof.FieldState, must func(error)) {
...
func guardCanonical(w *canonical.Writer, guard Guard, must func(error)) {
...
func placeCanonical(w *canonical.Writer, place Place, must func(error)) {
...
func editCanonical(w *canonical.Writer, edit Edit, must func(error)) {
...
func productCanonical(w *canonical.Writer, row ConstructorProduct, must func(error)) {
...
func applicationCanonical(w *canonical.Writer, row HelperApplication, must func(error)) {
...
func productLawCanonical(w *canonical.Writer, law ProductLaw, must func(error)) {
...
func chainCanonical(w *canonical.Writer, row ChainLaw, must func(error)) {
	must(w.Uint(uint64(row.Scope)))
	guardCanonical(w, row.Guard, must)
...
func helperLawCanonical(w *canonical.Writer, law HelperLaw, must func(error)) {
	must(w.Uint(uint64(law.Scope)))
