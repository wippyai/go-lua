...
import (
	...
	"github.com/wippyai/go-lua/program/internal/schema/relations/generator"
)
...
func main() {
	...
	semanticOutput := flag.String("semanticsource", "", "semantic-source Go output")
	...
	flag.Parse()
	if err := generator.Run(*input, *history, *retired, *semanticOutput, *relationOutput, *check, *writeHistory); err != nil {
