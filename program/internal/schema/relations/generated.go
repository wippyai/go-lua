...
func CatalogToken(name string) (semanticsource.Token, bool) {
	...
	case "LinkStatic@-":
		...
		return definition.Token(), definition != (semanticsource.RelationDef{})
	case "LinkStatic@LinkStaticResolution":
		definition := catalogDefinition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticResolution)
		return definition.Token(), definition != (semanticsource.RelationDef{})
	case "LinkStatic@LinkStaticExpression":
		definition := catalogDefinition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticExpression)
		return definition.Token(), definition != (semanticsource.RelationDef{})
	case "LinkStatic@LinkStaticExport":
		definition := catalogDefinition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticExport)
		return definition.Token(), definition != (semanticsource.RelationDef{})
	case "LinkStatic@LinkStaticInput":
		definition := catalogDefinition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticInput)
		return definition.Token(), definition != (semanticsource.RelationDef{})
	case "LinkHost@-":
...
func CatalogName(token semanticsource.Token) (string, bool) {
	...
	if token == catalogDefinition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticResolution).Token() {
		return "LinkStatic@LinkStaticResolution", true
	}
	if token == catalogDefinition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticExpression).Token() {
		return "LinkStatic@LinkStaticExpression", true
	}
	if token == catalogDefinition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticExport).Token() {
		return "LinkStatic@LinkStaticExport", true
	}
	if token == catalogDefinition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticInput).Token() {
		return "LinkStatic@LinkStaticInput", true
	}
...
func buildCanonicalSchema() (*Schema, error) {
	...
	return Seal(source, []Row{
		...
		{Definition: definition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticResolution), Owner: OwnerLinkStatic, Form: FormSealDerived, Parents: parents(definition(semanticsource.OriginLinkStatic, 0), definition(semanticsource.OriginLinkProjectShardMount, 0), definition(semanticsource.OriginProgramModuleImport, 0))},
		{Definition: definition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticExpression), Owner: OwnerLinkStatic, Form: FormSealDerived, Parents: parents(definition(semanticsource.OriginLinkStatic, 0), definition(semanticsource.OriginProgramStatic, semanticsource.FacetProgramStaticTypeRef))},
		{Definition: definition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticExport), Owner: OwnerLinkStatic, Form: FormSealDerived, Parents: parents(definition(semanticsource.OriginLinkStatic, 0), definition(semanticsource.OriginProgramStatic, semanticsource.FacetProgramStaticPublication), definition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticExpression), definition(semanticsource.OriginProgramModuleEntry, semanticsource.FacetProgramModuleEntryRootCell))},
		{Definition: definition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticInput), Owner: OwnerLinkStatic, Form: FormSealDerived, Parents: parents(definition(semanticsource.OriginLinkStatic, semanticsource.FacetLinkStaticExpression), definition(semanticsource.OriginProgramStatic, semanticsource.FacetProgramStaticTypeof), definition(semanticsource.OriginProgramStatic, semanticsource.FacetProgramStaticAnnotation), definition(semanticsource.OriginProgramFlowValues, 0), definition(semanticsource.OriginProgramFlowBody, semanticsource.FacetProgramFlowBodyRoots), definition(semanticsource.OriginProgramSourceProvenance, 0))},
